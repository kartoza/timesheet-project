// Taken from https://github.com/webgeodatavore/GeoJSON.Terminator/blob/master/index.js

export const julian = (date : any) => {
...
class Terminator {
    ...
    _hourAngle (lng: number, sunPos: any, gst: number) {
    ...
    _latitude (ha: number, sunPos: any) {
