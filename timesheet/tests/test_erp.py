...
class TestResolveIssueCustomer(TestCase):
    ...
    def test_email_exact_match_used_when_no_project(self):
        SupportContactMapping.objects.create(email='elie.gerges@un-igrac.org', customer='UN-IGRAC')
        customer, is_internal = _resolve_issue_customer(None, 'elie.gerges@un-igrac.org')
        self.assertEqual(customer, 'UN-IGRAC')
        self.assertFalse(is_internal)
    ...
    def test_mapping_with_blank_customer_is_internal(self):
        SupportContactMapping.objects.create(email='dylanpivo@gmail.com', customer='')
        customer, is_internal = _resolve_issue_customer(None, 'dylanpivo@gmail.com')
        self.assertEqual(customer, '')
        self.assertTrue(is_internal)
